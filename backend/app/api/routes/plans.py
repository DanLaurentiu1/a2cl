...
async def create_plan(
    plan_data: PlanJSON, repo: PlanServerRepository = Depends(get_repository)
):
    try:
...
async def get_plan(plan_id: int, repo: PlanServerRepository = Depends(get_repository)):
    try:
...
async def delete_plan(
    plan_id: int, repo: PlanServerRepository = Depends(get_repository)
):
    try:
